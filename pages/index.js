...
export default function Home({ propertyForRent, propertyForSale }) {
  { propertyForRent.map(i => console.log(i)) }
  return (
    <Box>
      <Banner
        purpose={'RENT A HOME'}
        ...
        imageUrl='https://kreatecube.com/usefull/vendor/26046/gallery/14681.jpg'
      />
      ...
      <Banner
        ...
        imageUrl='https://i.ytimg.com/vi/4YSW2o4N0lc/maxresdefault.jpg'
      />
      <Flex flexWrap='wrap' justifyContent={'center'}>
